...
export const AppButton = ({
  ...
  const buttonTextStyles = {
    ...
    ...((variant === "ghost" || variant === "outline") && {
      "text-gray-100": colorScheme === "gray",
  ...
  const buttonBackgroundHoverStyles = {
    ...
    ...((variant === "ghost" || variant === "outline") && {
      "hover:bg-gray-400": colorScheme === "gray",
  ...
  const BUTTON_DEFAULT_STYLES =
    "font-medium appearance-none transition duration-500 rounded-md focus:outline-none inline-flex items-center disabled:bg-opacity-70 disabled:cursor-not-allowed";
